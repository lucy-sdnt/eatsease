...
<body>
    ...
    <div class="container">
        ...
        <a href="/formularioCategorias" style="display: inline-block; text-decoration: none; font-size: 16px; font-weight: 600; color: #fff; background-color: #f48d59; padding: 10px 20px; border-radius: 4px; transition: background-color 0.3s ease-in-out;">Agregar</a>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="action-btns">
                    ...
                    <a href="{{ url('/delete_categories/' . $dato->id) }}" class="text-danger" title="Eliminar" onclick="return confirm('¿Estás seguro de que quieres eliminar esta categoría?')">
