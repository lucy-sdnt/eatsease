...
<body>
    ...
    <div class="container">
        ...
        <a href="/formularioPago" style="display: inline-block; text-decoration: none; font-size: 16px; font-weight: 600; color: #fff; background-color: #f48d59; padding: 10px 20px; border-radius: 4px; transition: background-color 0.3s ease-in-out;">Agregar</a>
        <br><br>
        <table>
            <tr>
                <th>Tipo de pago</th>
            ...
            <tr>
                ...
                <td class="action-btns">
                    ...
                    <a href="{{url('/delete_payment/' . $dato->id)}}" class="text-danger" title="Eliminar" onclick="return confirm('¿Estás seguro de que quieres eliminar esta reservación?')">
