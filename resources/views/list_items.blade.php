...
<head>
    ...
    <title>Contenidos de Orden</title>
    ...
    <style>
        ...
        a[href="/formularioProductos"]:hover {
...
<body>
    ...
    <div class="container">
        <h2>Productos</h2>
        <a href="/formularioProductos" style="display: inline-block; text-decoration: none; font-size: 16px; font-weight: 600; color: #fff; background-color: #f48d59; padding: 10px 20px; border-radius: 4px; transition: background-color 0.3s ease-in-out;">Agregar</a>
        <br><br>
        <table>
            <tr>
                <th>Cantidad</th>
                <th>Instrucciónes especiales</th>
                <th>Fecha</th>
                <th>Producto</th>
                <th>Acciones</th> 
            </tr>
            ...
            <tr>
                ...
                <td class="action-btns">
                    ...
                    <a href="{{url('/delete_items/' . $dato->id)}}" class="text-danger" title="Eliminar" onclick="return confirm('¿Estás seguro de que quieres eliminar este item?')">
