...
<body>
    ...
    <form action="{{route('inventory.insertar')}}" method="post">
        @csrf
        <label>Nombre del producto</label>
        <input type="text" name="name_in"><br>
        <label>Cantidad</label>
        <input type="number" name="quantity_in"><br>
        <label>Unidad</label>
        ...
        <select name="supplier_id">
            ...
            @foreach ($datos_suppliers as $dato)
                <option value="{{$dato->id}}">{{$dato->name_s}}</option>
            @endforeach
        </select>
        <br>
        ...
        <a href="/listadoInventario">Ver lista</a>
    </form>
</body>
</html>